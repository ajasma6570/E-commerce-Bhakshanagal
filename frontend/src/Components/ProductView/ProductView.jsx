      ...
      <section class="py-5">
        <div class="container">
          <div class="row ">
            ...
            <main class="col-lg-6">
              <div class="ps-lg-3">
                <h4 class="title text-dark">Bingo Spicy chilly</h4>
                ...
                <p>
                  Bingo Bingio Bingo Bingio Bingo Bingio Bingo Bingio Bingo
                  Bingio Bingo Bingio Bingo Bingio Bingo Bingio Bingo Bingio
                  Bingo Bingio
                </p>
